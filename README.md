This program analyzes an F1 driver's qualifying performance across multiple seasons by comparing their fastest laps to their teammate’s. It highlights which tracks the driver excels at most based on average qualifying gap.
